...
export default function WorkCard({ title, description, icon }: WorkCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-[#FF851B]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      <div className="relative z-10 flex items-start gap-6">
        <div className="text-5xl">{icon}</div>
        <div>
          <h2 className="text-xl font-bold text-white group-hover:text-[#FF851B] transition-colors duration-300">
            {title}
          </h2>
