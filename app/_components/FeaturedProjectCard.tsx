  ...
  return (
    ...
    >
      ...
      {/* ==========================================
          💳 右半分：巨大なアイコンと光のエリア
          ========================================== */}
      <div className="w-full md:w-1/2 bg-black rounded-4xl aspect-video flex items-center justify-center border border-zinc-800 overflow-hidden relative shadow-inner">
